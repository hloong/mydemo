...
public class BaseViewHolder {
    ...
    static BaseViewHolder get(Context context, View convertView,ViewGroup parent, int layoutId, int position) {
        if (convertView == null) {
     ...
     * on it, not covered by the BaseViewHolder.<br/>
    ...
    /**
     * 设置listview下的子布局比如gridview或listview的条目点击事件
     * 主要适用于 listview包含gridview或listview的场景
     * @param viewId
     *            The view id.
     * @param listener
     *            The on click listener;
