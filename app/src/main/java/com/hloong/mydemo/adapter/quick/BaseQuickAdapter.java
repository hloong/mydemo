...
public abstract class BaseQuickAdapter<T, H extends BaseViewHolder> extends BaseAdapter {
    ...
    protected MultiItemTypeInterface<T> mMultiItemSupport;

    public BaseQuickAdapter(Context context, ArrayList<T> data,
            MultiItemTypeInterface<T> multiItemSupport) {
    ...
    /**
     * You can override this method to use a custom BaseViewHolder in order
     * to fit your needs
     * 
     * @param position
