...
public class LineGraphView extends GraphView {
	...
	private void init() {
		...
		paintBackground.setColor(Color.rgb(234, 81, 51));
...
//		paint.setColor(Color.rgb(0, 113, 185));// 小圆圈颜色（深蓝色）
		// 先绘制蓝色圆
		// TODO endY + style.thickness - 3
	...
	private void drawMarker(Canvas canvas, String content, float x, float y) {
		...
		DecimalFormat decimalFomat = new DecimalFormat("0.0000");
		// 保留小数上面
...
//		paint.setColor(Color.rgb(45, 167, 224));// 淡蓝色(图标颜色)///////
		...
		canvas.drawRoundRect(r,
				DensityUtil.dip2px(context, GraphViewConfig.RECTF_RADIUS),
				DensityUtil.dip2px(context, GraphViewConfig.RECTF_RADIUS), paint);
		...
		path.lineTo(x - DensityUtil.dip2px(context, 5),y
