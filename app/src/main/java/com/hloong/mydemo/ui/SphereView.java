...
public class SphereView extends View {
    ...
    //每一格 cos y的差距
    private final float degreeSizeY=(float) (R1*Math.cos(1*Math.PI/180));
    ...
    public SphereView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        ...
        width = DisplayUtils.getWidth(mContext)/2;
        height = DisplayUtils.getHeight(mContext)/3;
